export default function ServiceBanner(){
    return(
        <div className="bg-landingBlack m-10 text-white lg:p-20 md:p-10 p-6 rounded-3xl flex lg:flex-row flex-col gap-8 justify-between items-center font-semibold">
