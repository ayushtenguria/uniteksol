        ...
        <div className="flex gap-4 m-10 grid-cols-2 justify-between text-fontBlack">
            <div className="w-1/2">
                ...
                <div>
                    ...
                    <div>
                        <Card title={"Title"} bgColor="landingGray"><span className="text-lg font-bold pb-2">Title</span>Lorem ipsum dolor amet, consectetur adipiscing elit. Faucibus in libero.Lorem ipsum dolor amet,<Image></Image></Card>
                    </div>
                </div>
            </div>
            <div className="w-1/2">
